                ...
                <form method="GET" action="" class="hourOfDateForm">
                    ...
                    if (!empty($horairesRestants)) {
                        foreach ($horairesRestants as $horaire) {
                           ...
                           <input type='radio' name='modifyHoraire' value='" . htmlspecialchars($horaire, ENT_QUOTES) . "'>
                    ...
                    ?>
                    <input type="hidden" name="modifDateRDV" value="<?php echo $dateChoisie ?>">
                    <hr>
                    <?php echo '<button type="submit" class="rdv">Modifier votre RDV</button>'; ?>
                </form>
